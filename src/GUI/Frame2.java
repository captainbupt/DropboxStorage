		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					window.frmDropboxStorage.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
...
///////////////////////////////////////////////////////////////////////////////		
		...
		JRadioButtonMenuItem rdbtnmntmBySize = new JRadioButtonMenuItem("By Size");
		rdbtnmntmBySize.setFont(new Font("Segoe UI", Font.PLAIN, 20));
		mnArrangeItems.add(rdbtnmntmBySize);
		
		JRadioButtonMenuItem rdbtnmntmByName = new JRadioButtonMenuItem("By Name");
		rdbtnmntmByName.setFont(new Font("Segoe UI", Font.PLAIN, 20));
		mnArrangeItems.add(rdbtnmntmByName);
		
		JRadioButtonMenuItem rdbtnmntmByDate = new JRadioButtonMenuItem("By Date");
